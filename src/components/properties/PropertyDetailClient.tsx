                    ...
                    <div className="fixed bottom-6 right-6 z-50">
                        <div className="relative group">
                            ...
                            >
                                ...
                                {/* Tooltip Premium */}
                                <div className="absolute right-full mr-4 px-5 py-2.5 bg-stone-950/95 backdrop-blur-md border border-brand-gold/40 text-stone-100 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.3)] opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap text-sm pointer-events-none transform translate-x-4 group-hover:translate-x-0 font-outfit">
                                    <span className="text-brand-gold font-bold mr-1">¡Hablemos!</span> Escríbenos al WhatsApp
                                    {/* Arrow */}
                                    <div className="absolute top-1/2 -right-2 w-3 h-3 bg-stone-950 border-t border-r border-brand-gold/40 transform -translate-y-1/2 rotate-45"></div>
                                </div>
                            </a>
                        </div>
                    </div>
