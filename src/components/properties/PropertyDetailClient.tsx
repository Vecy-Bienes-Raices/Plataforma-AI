                    ...
                    <div className="fixed bottom-6 right-6 z-50">
                        <div className="relative group">
                            ...
                            <a
                                ...
                                className="relative flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_25px_rgba(37,211,102,0.6)] hover:scale-105 transition-all duration-300 border-2 border-white/20"
                            >
                                ...
                                {/* Tooltip */}
                                <div className="absolute right-full mr-4 px-4 py-2 bg-white text-[#25D366] font-bold rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap text-sm pointer-events-none transform translate-x-2 group-hover:translate-x-0 transition-transform">
